...
# 데이터베이스 연결 및 테이블 생성, 암호화를 위한 키 생성을 수행합니다.
# 초기 페이지에 대한 라우트를 설정하고, 사용자가 로그인한 경우 사용자명을 전달합니다.
# 설문 추가 페이지와 질문 추가 페이지를 처리합니다. 사용자가 설문을 작성하고 완료하면 데이터베이스에 저장됩니다.
# 설문 목록을 가져오는 함수와 설문 목록 페이지에 대한 라우트를 설정합니다.
# 특정 설문의 내용을 가져오는 함수와 해당 설문을 보여주는 페이지에 대한 라우트를 설정합니다.
# 설문 작성 및 답변에 대한 기능을 구현합니다. 사용자가 답변을 제출하면 해당 내용이 암호화되어 저장됩니다.
# 설문 검색 기능을 추가합니다. 사용자가 검색어를 입력하면 해당하는 설문을 찾아 보여줍니다.
# 회원 정보 관련 기능을 구현합니다. 회원가입, 로그인, 로그아웃 등의 기능을 제공합니다.
